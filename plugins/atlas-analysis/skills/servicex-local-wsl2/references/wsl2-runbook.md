...
This runbook is the concrete procedure behind `servicex-local-wsl2`. Replace
`C:\Temp\servicex-local\run-001` with a temporary directory you control. Do
not use the repository directory for data or generated files.
